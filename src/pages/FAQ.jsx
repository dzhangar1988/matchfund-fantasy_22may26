      ...
      answer: (
        <>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-3">
            <li><strong>Исход матча (3 очка, 1 кредит):</strong> Кто выиграет или ничья.</li>
            <li><strong>Обе забьют (2 очка, 1 кредит):</strong> Да или Нет.</li>
            <li><strong>Количество голов (2.5 очка, 1 кредит):</strong> 3+ голов или 0-2 гола.</li>
            <li><strong>Будет ли разгром? (2.5 очка, 1 кредит):</strong> Разница 3+ гола или нет.</li>
            <li><strong>Победа всухую (4 очка, 1 кредит):</strong> Команда выиграет, не пропустив.</li>
            <li><strong>Точный счёт (6 очков, 1 кредит):</strong> Угадайте точный итоговый счёт.</li>
          </ul>
