      ...
      answer: (
        <>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-3">
            <li><strong>Bold прогноз (3 очка, 1 кр):</strong> Победа 1/Ничья/Победа 2.</li>
            <li><strong>Обе забьют (2 очка, 1 кр):</strong> Да или Нет.</li>
            <li><strong>ТБ/ТМ 2.5 (2.5 очка, 1 кр):</strong> Больше или меньше 2.5 голов.</li>
            <li><strong>Фора ±1 (2.5 очка, 1 кр):</strong> П1 Фора -1 или П2 Фора +1.</li>
            <li><strong>Победа с нулём (4.5 очка, 1.5 кр):</strong> П1 или П2 выиграют без пропущенных мячей.</li>
            <li><strong>Точный счёт (9 очков, 3 кр):</strong> Угадайте точный итоговый счёт.</li>
          </ul>
